...
Original file is located at
    https://colab.research.google.com/drive/1rrPl73MXZ24aBI-WWa8EdPNrzMlI44Zd
...
# Fyrir Google Colab
WEATHER_FILE = Path("Vedurgogn_ID_66.csv")
FLOW_FILE = Path("Rennslisgogn_ID_66.csv")
ATTRIBUTE_FILE = Path("Eiginleikar Vatnasviðs Catchment_attributes.csv")
